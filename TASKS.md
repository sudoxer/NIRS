...
## Seed
- [x] Добавлен `backend/seed.py` для пересоздания БД и генерации заглушек: классы 0-11 A-G, 10-15 учеников на класс, большой набор учителей, предметов и назначений.
...
- [x] Teacher Dashboard переведен в формат табеля (строки: ученики, столбцы: даты) + выбор учителя для admin.
- [x] Student Dashboard переведен в формат табеля (строки: даты, столбцы: предметы).
- [x] Улучшен UI: вкладки и обновленные стили для удобной навигации.
